...
from conan_explorer.ui import (
    BaseSignals,
    PageStore,
    PluginDescription,
    PluginInterfaceV1,
    compile_ui_file_if_newer,
)
...
# Then this will automatically recreate the .py representation of it,
...
class SamplePluginView(PluginInterfaceV1):
    ...
    def _init_right_menu(self):
        ...
        menu.add_button_menu_entry(
            "My Button", self.on_option_button, "icons/opened_folder.svg"
        )
        menu.add_menu_line()
...
if __name__ == "__main__":
    ...
    qapp = QApplication([])
    window = QMainWindow()
    pl = SamplePluginView(window, {})  # type: ignore
