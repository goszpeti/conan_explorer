...
class LocalConanPackageExplorer(PluginInterfaceV1):
    ...
    def _init_pkg_file_context_menu(self):
        ...
        self._open_fm_action.triggered.connect(self._pkg_file_exp_ctrl.on_open_file_in_file_manager)
        ...
        self._copy_as_path_action.triggered.connect(self._pkg_file_exp_ctrl.on_copy_file_as_path)
        ...
        self._open_terminal_action.triggered.connect(self._pkg_file_exp_ctrl.on_open_terminal_in_dir)
        ...
        self._rename_action.triggered.connect(self._pkg_file_exp_ctrl.on_file_rename)
        ...
        self._copy_action.triggered.connect(self._pkg_file_exp_ctrl.on_file_copy)
        ...
        self._cut_action.triggered.connect(self._pkg_file_exp_ctrl.on_file_cut)
        ...
        self._paste_action.triggered.connect(self._pkg_file_exp_ctrl.on_file_paste)
        ...
        self._delete_action.triggered.connect(self._pkg_file_exp_ctrl.on_file_delete)
        ...
        self._add_link_action.triggered.connect(self._pkg_file_exp_ctrl.on_add_app_link_from_file)
