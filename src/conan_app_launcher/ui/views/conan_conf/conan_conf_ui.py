...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.info_contents.setGeometry(QtCore.QRect(0, 0, 573, 400))
        ...
        self.profiles_list_view = QtWidgets.QListView(self.profiles)
        ...
        self.verticalLayout_5.addWidget(self.profiles_list_view)
        self.profiles_text_browser = QtWidgets.QTextBrowser(self.profiles)
        self.profiles_text_browser.setReadOnly(False)
        self.profiles_text_browser.setObjectName("profiles_text_browser")
        self.verticalLayout_5.addWidget(self.profiles_text_browser)
