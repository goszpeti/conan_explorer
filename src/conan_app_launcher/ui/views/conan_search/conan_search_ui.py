...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        sizePolicy1.setHeightForWidth(self.remotes_label.sizePolicy().hasHeightForWidth())
        self.remotes_label.setSizePolicy(sizePolicy1)
        font = QFont()
        font.setBold(True)
        ...
        sizePolicy2.setHeightForWidth(self.remote_list.sizePolicy().hasHeightForWidth())
        self.remote_list.setSizePolicy(sizePolicy2)
        ...
        sizePolicy1.setHeightForWidth(self.results_label.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy1.setHeightForWidth(self.package_info_label.sizePolicy().hasHeightForWidth())
        self.package_info_label.setSizePolicy(sizePolicy1)
