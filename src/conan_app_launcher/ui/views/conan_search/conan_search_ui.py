...
from PySide6.QtWidgets import (QAbstractItemView, QAbstractScrollArea, QApplication, QFrame,
    ...
    QSizePolicy, QSplitter, QTextBrowser, QTreeView,
    QVBoxLayout, QWidget)
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.search_icon.setMinimumSize(QSize(30, 0))
        self.search_icon.setMaximumSize(QSize(30, 16777215))
        ...
        self.search_line.setMinimumSize(QSize(200, 0))
        self.search_line.setMaximumSize(QSize(16777215, 16777215))
        self.search_line.setSizeIncrement(QSize(1, 0))
        ...
        self.search_button.setMinimumSize(QSize(50, 0))
        self.search_button.setMaximumSize(QSize(100, 16777215))
        self.search_button.setSizeIncrement(QSize(0, 0))
        ...
        self.remotes_label = QLabel(self.splitter)
        self.remotes_label.setObjectName(u"remotes_label")
        sizePolicy2 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.remotes_label.sizePolicy().hasHeightForWidth())
        self.remotes_label.setSizePolicy(sizePolicy2)
        font = QFont()
        font.setBold(True)
        self.remotes_label.setFont(font)
        self.splitter.addWidget(self.remotes_label)
        self.remote_list = QListWidget(self.splitter)
        ...
        self.remote_list.setMinimumSize(QSize(0, 50))
        ...
        self.splitter.addWidget(self.remote_list)
        self.views_splitter = QSplitter(self.splitter)
        ...
        sizePolicy4.setHeightForWidth(self.views_splitter.sizePolicy().hasHeightForWidth())
        self.views_splitter.setSizePolicy(sizePolicy4)
        ...
        sizePolicy2.setHeightForWidth(self.results_label.sizePolicy().hasHeightForWidth())
        self.results_label.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.package_info_label.sizePolicy().hasHeightForWidth())
        self.package_info_label.setSizePolicy(sizePolicy2)
        ...
        self.splitter.addWidget(self.views_splitter)
    ...
    def retranslateUi(self, Form):
        ...
        self.search_icon.setText(QCoreApplication.translate("Form", u"Icon", None))
        ...
        self.remotes_label.setText(QCoreApplication.translate("Form", u"Remotes", None))
