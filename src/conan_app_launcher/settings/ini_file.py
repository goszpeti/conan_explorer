...
from . import (AUTO_INSTALL_QUICKLAUNCH_REFS, CONSOLE_SPLIT_SIZES, FILE_EDITOR_EXECUTABLE, FONT_SIZE,
...
class IniSettings(SettingsInterface):
    ...
    def add(self, name: str, value: Union[str, int, float, bool], node: str):
