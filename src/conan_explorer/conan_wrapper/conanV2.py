...
from conan_explorer import INVALID_PATH, Version, conan_version, user_save_path
...
class ConanApi(ConanCommonUnifiedApi, metaclass=SignatureCheckMeta):
    ...
    def get_conan_buildinfo(
        ...
        """Currently there is no equivalent to txt generator from ConanV1"""
    ...
    def get_editable(self, conan_ref: Union[ConanRef, str]) -> EditablePkg:
        ...
        return EditablePkg(
            str(conan_ref),
            editable_dict.get("path", INVALID_PATH),
