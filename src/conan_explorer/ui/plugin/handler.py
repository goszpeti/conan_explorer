...
from conan_explorer import BUILT_IN_PLUGIN, Version, base_path, conan_version
...
class PluginHandler(QObject):
    ...
    def _load_plugin(
        self, plugin: PluginDescription, reload=False
    ) -> Optional[PluginInterfaceV1]:
        loaded_plugin = None
    ...
    def get_plugin_by_description(
        self, plugin_descr: PluginDescription
    ) -> Optional[PluginInterfaceV1]:
