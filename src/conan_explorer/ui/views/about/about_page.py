...
from conan_explorer import APP_NAME, AUTHOR, BUILT_IN_PLUGIN, REPO_URL, __version__, asset_path
...
class AboutPage(PluginInterfaceV1):
    def __init__(self, parent, base_signals):
        ...
        html_content = template.render(
            app_name=APP_NAME, version=__version__, author=AUTHOR, repo_url=REPO_URL
        )
