...
class ConanConfigView(PluginInterfaceV1):
    ...
    def _init_profiles_tab(self):
        ...
        self.set_themed_icon(self._ui.profiles_copy_name_button, "icons/copy_to_clipboard.svg")
    ...
    def _load_profiles_tab(self):
        ...
        self._ui.profiles_list_view.selectionModel().selectionChanged.connect(
    ...
    def _init_remotes_tab(self):
        ...
        self._ui.remote_move_top_button.clicked.connect(self._remotes_controller.move_to_top)
    ...
    def on_editable_edit(self, model_index):
        ...
        if not editable:
            return
        self.remote_edit_dialog = EditableEditDialog(editable, self._editable_controller, self)
        self.remote_edit_dialog.exec()
    ...
    def on_editable_remove(self, model_index):
        ...
        message_box.setText(
            "Are you sure, you want to delete the editable" + f"{editable_item.conan_ref}?"
        )
