...
from PySide6.QtWidgets import QApplication, QListWidget, QPushButton, QTextBrowser, QTreeView
...
class ConanSearchController(QObject):
    ...
    def _load_search_model(self):
        ...
        self._model.setup_model_data(
            self._search_line.text(),
            self.get_selected_remotes(),
    ...
    def on_show_conanfile_requested(self):
        ...
        loader.load(
            self._view, show_conanfile, (conan_ref,), loading_text="Opening Conanfile..."
        )
