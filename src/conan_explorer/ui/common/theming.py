...
from conan_explorer.settings import GUI_STYLE, GUI_STYLE_FLUENT, GUI_STYLE_MATERIAL
...
def get_themed_asset_icon(
    image_path: str, force_light_mode=False, force_dark_mode=False
) -> QIcon:
...
class ThemedWidget(QWidget):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self._icon_map: Dict[
            Union[CanSetIconWidgetProtocol, CanSetPixmapWidgetProtocol], ThemedWidget.IconInfo
        ] = {}  # widget: {name, size} for re-theming

    def set_themed_icon(
        self,
        widget: Union[CanSetIconWidgetProtocol, CanSetPixmapWidgetProtocol],
        asset_path: str,
